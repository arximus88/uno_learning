...
unsigned char smile2[] = {0x00, 0x00, 0x1c, 0x02, 0x0a, 0x02, 0x5c, 0x40, 0x40, 0x5c, 0x02, 0x0a, 0x02, 0x1c, 0x00, 0x00};
unsigned char smile3[] = {0x00, 0x00, 0x1c, 0x02, 0x02, 0x0a, 0x5c, 0x40, 0x40, 0x5c, 0x02, 0x02, 0x0a, 0x1c, 0x00, 0x00};
unsigned char smile4[] = {0x00, 0x00, 0x1c, 0x0a, 0x02, 0x02, 0x5c, 0x40, 0x40, 0x5c, 0x0a, 0x02, 0x02, 0x1c, 0x00, 0x00};
...
void loop()
{
    matrix_display(smile2); // display the smile image
    delay(2000);           // delay 1s
    matrix_display(smile3);   // display the kit image
    delay(500);           // delay 1s
    matrix_display(smile2);   // display the kit image
    delay(2000);           // delay 1s
    matrix_display(smile4);   // display the kit image
    delay(500);           // delay 1s
}